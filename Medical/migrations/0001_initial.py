# Generated by Django 3.0.4 on 2020-07-23 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('company_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Medical.Company')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalDetails',
            fields=[
                ...
                ('description', models.CharField(max_length=255)),
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('medicine_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Medical.Medicine')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeSalary',
